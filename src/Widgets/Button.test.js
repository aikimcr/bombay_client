...
it('should show a simple button', async () => {
    ...
    const { asFragment } = render(<Button label='xyzzy' disabled={disabled} onClick={clickHandler} />);
...
it('should respect classnames', async () => {
    ...
    render(<Button className='foobar' label='xyzzy' disabled={disabled} onClick={clickHandler} />);
    const actualButton = screen.getByText(/xyzzy/);
